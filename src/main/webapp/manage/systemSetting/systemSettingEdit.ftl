...
<form action="${basepath}/manage/systemSetting.action" id="form">
	...
	<div id="tabs-1">
		<table class="table table-condensed">
					...
					<tr>
						...
						<td style="text-align: left;"><input type="text" name="e.version" value="${e.version!""}" id="version" data-rule="required;version;length[0~100];"/>
							</td>
					</tr>
					<tr>
						<td style="text-align: right;width: 100px">系统代号</td>
						<td style="text-align: left;"><input type="text"  name="e.systemCode" value="${e.systemCode!""}"
								id="systemCode" data-rule="required;systemCode;length[1~30];"/></td>
					</tr>
					<tr>
						<td style="text-align: right;width: 100px">名称</td>
						<td style="text-align: left;"><input type="text"  name="e.name" value="${e.name!""}"
								id="name" data-rule="required;name;length[1~30];"/></td>
					</tr>
					<tr>
						<td style="text-align: right;">门户地址</td>   
						<td style="text-align: left;"><input type="text"  name="e.www" size="100" value="${e.www!""}"
								id="www" data-rule="required;www;length[1~100];"/></td>
					</tr>
					<tr>
						<td style="text-align: right;">后台地址</td>   
						<td style="text-align: left;"><input type="text"  name="e.manageHttp" size="100"  value="${e.manageHttp!""}"
								id="manageHttp" data-rule="required;manageHttp;length[1~100];"/></td>
					</tr>
					<tr>
						<td style="text-align: right;">log</td>
						<td style="text-align: left;"><input type="text"  name="e.log"  value="${e.log!""}"
								id="log" data-rule="required;log;length[0~100];"/></td>
					</tr>
					<tr>
						<td style="text-align: right;">网站标题</td>
						<td style="text-align: left;"><input type="text"  name="e.title"  value="${e.title!""}"
								id="title" data-rule="required;title;length[0~100];"/></td>
					</tr>
					<tr>
						<td style="text-align: right;">description</td>
						<td style="text-align: left;">
                            <input type="text"  id="description" name="e.description" value="${e.description!""}" data-rule="required;description;length[0~100];"/>
						</td>
					</tr>
					<tr>
						<td style="text-align: right;">keywords</td>
						<td style="text-align: left;">
							<input type="text"  id="keywords" name="e.keywords" value="${e.keywords!""}" data-rule="required;keywords;length[0~100];"/>
						</td>
					</tr>
					<tr>
						<td style="text-align: right;">shortcuticon</td>
						<td style="text-align: left;">
							<input type="text"  id="shortcuticon" name="e.shortcuticon" value="${e.shortcuticon!""}" data-rule="required;shortcuticon;length[0~100];"/>
						</td>
					</tr>
					<tr>
						<td style="text-align: right;">联系地址</td>
						<td style="text-align: left;">
							<input type="text"  id="address" name="e.address" value="${e.address!""}" data-rule="required;address;length[0~100];"/>
						</td>
					</tr>
					<tr>
						<td style="text-align: right;">联系电话</td>
						<td style="text-align: left;">
							<input type="text"  id="tel" name="e.tel"  value="${e.tel!""}"/>
						</td>
					</tr>
					<tr>
						<td style="text-align: right;">邮箱</td>
						<td style="text-align: left;">
							<input type="text"  id="email" name="e.email" value="${e.email!""}" data-rule="required;email;length[0~100];"/>
						</td>
					</tr>
					<tr>
						<td style="text-align: right;">备案号</td>
						<td style="text-align: left;">
							<input type="text"  id="icp" name="e.icp"  value="${e.icp!""}" data-rule="required;icp;length[0~100];"/>
						</td>
					</tr>
					<tr>
						<td style="text-align: right;">站长统计代码</td>
						<td style="text-align: left;">
							<textarea id="statisticsCode" cols="300" rows="6" name="e.statisticsCode" data-rule="required;statisticsCode;length[10~1000];">${e.statisticsCode!""}</textarea>
						</td>
					</tr>
					<tr>
						<td style="text-align: right;">是否开放网站</td>
						<td style="text-align: left;">
							<input type="checkbox" id="isopen" name="e.isopen" <#if e.isopen=="true">checked="checked"</#if> />
						</td>
					</tr>
					<tr>
						<td style="text-align: right;">关闭信息</td>
						<td style="text-align: left;">
							<textarea id="closeMsg" name="e.closeMsg" cols="300" rows="6">${e.closeMsg!""}</textarea>
						</td>
					</tr>
				</table>
	</div>
		...
		<table class="table table-condensed">
			<tr>
				...
				<td style="text-align: left;">
					...
					<select id="unit" name="e.openResponsive"></select>
			...
			<tr>
				...
				<td style="text-align: left;"><input type="text"  name="e.imageRootPath"  value="${e.imageRootPath!""}"
						id="imageRootPath" data-rule="required;imageRootPath;length[0~100];"/></td>
			</tr>
			<tr>
				<td style="text-align: right;">产品默认图片</td>
				<td style="text-align: left;"><input type="text"  name="e.defaultProductImg"  value="${e.defaultProductImg!""}"
			...
			<tr>
				...
				<td style="text-align: left;"><input type="text"  name="e.manageLeftTreeLeafIcon"  value="${e.manageLeftTreeLeafIcon!""}"
		...
		<table class="table table-condensed">
			<tr>
				...
				<td style="text-align: left;">
                    ...
                    <select id="style" name="e.style" class="input-medium" onchange="changeStyle()" >
		...
		<table class="table table-bordered">
			<tr>
				<td style="text-align: left;" colspan="2">
					...
					<textarea name="e.qqHelpHtml" style="width:100%;height:200px;visibility:hidden;">${e.qqHelpHtml!""}</textarea>
				</td>
			</tr>
		</table>
	</div>
