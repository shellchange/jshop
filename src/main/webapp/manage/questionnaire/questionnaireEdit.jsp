...
<!-- 		<input type="button" id="addQuestionItemBtn" value="增加题目" onclick="return addQuestionItemFunc(this);" class="btn btn-warning"/> -->
		<s:submit method="deleteItem" onclick="return deleteSelect();" value="删除题目" cssClass="btn btn-warning"/>
	</s:else>
		...
		<tr>
			<td colspan="2" style="text-align: center;">
				<s:if test="e.questionnaireItem.id=='' or e.questionnaireItem.id==null">
					<s:submit method="insertQuestionItem" action="questionnaire"  onclick="return onSubmit(this);" value="新增题目" cssClass="btn btn-warning"/>
				</s:if>
				<s:else>
					<s:submit method="insertQuestionItem" action="questionnaire"  onclick="return onSubmit(this);" value="修改题目" cssClass="btn btn-warning"/>
				</s:else>
