...
<div id="menuContainer" style="background-color: #C1DAD7">

<div id="loadImg" style="text-align: center;">
	<img style="margin-top: 20px;" alt="菜单加载中......" src="${basepath}/resource/images/loader.gif"><br>资源加载中...
</div>
	...
	var setting = {
			check: {
                ...
                beforeClick:function(treeId, treeNode){
                    if(treeNode._url == undefined){
                        treeNode._url = treeNode.url;
