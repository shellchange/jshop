...
<body>
	<s:form action="indexImg" namespace="/manage" theme="simple" enctype="multipart/form-data">
		...
		<table class="table table-bordered">
			...
			<tr>
				<th>排序</th>
				<td style="text-align: left;"><s:textfield name="e.order1" data-rule="排序:integer;order1;length[1~5];" 
						id="order1" /></td>
			</tr>
			<tr>
				<th>描述</th>
				<td style="text-align: left;"><s:textfield name="e.desc1" data-rule="排序:desc1;length[1~100];"  
						id="desc1" /></td>
			</tr>
			<tr>
